...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/fullpage.js/dist/fullpage.css":
/*!************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/fullpage.js/dist/fullpage.css ***!
  \************************************************************************************************************************************/
...
var content = __webpack_require__(/*! !../../css-loader??ref--6-1!../../postcss-loader/src??ref--6-2!./fullpage.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/fullpage.js/dist/fullpage.css");
...
/* harmony import */ var fullpage_js_dist_fullpage_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fullpage.js/dist/fullpage.css */ "./node_modules/fullpage.js/dist/fullpage.css");
/* harmony import */ var fullpage_js_dist_fullpage_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fullpage_js_dist_fullpage_css__WEBPACK_IMPORTED_MODULE_1__);
...
var iFullPage = new fullpage_js__WEBPACK_IMPORTED_MODULE_0___default.a('#fullpage', {
  navigation: true,
  navigationPosition: 'right',
  navigationTooltips: ['Acceuil', 'Notre Concept'],
  anchors: ['home', 'presentation', 'services', 'realisations', 'testimonials', 'contact'],
  ...
  onLeave: function onLeave(origin, destination, direction) {
    if (origin.index === 0 || destination.index === 0) {
      ...
      var underline = document.querySelector('#section2 .underline');
      var navbar = document.querySelector('.navbar');
      var logoSize = origin.index === 0 ? '50px' : '200px';
    ...
    if (destination.index === 2) {
      if (document.documentElement.clientWidth < 1279) {
        var services = document.querySelectorAll('#section3 .services');
        services.forEach(function (s) {
          s.classList.add('centered');
        });
      }

      var _underline = document.querySelector('#section3 .underline');

      _underline.classList.add('extended');

      var columns = document.querySelectorAll('#section3 .column');
    ...
    if (origin.index === 2) {
      if (document.documentElement.clientWidth > 767) {
        var _columns = document.querySelectorAll('#section3 .column');

        _columns.forEach(function (c) {
          c.classList.remove('centered');
        });

        var _services = document.querySelectorAll('#section3 .services');

        _services.forEach(function (s) {
          s.classList.remove('centered');
        });

        var _underline2 = document.querySelector('#section3 .underline');

        _underline2.classList.remove('extended');
      }
    }

    if (destination.index === 3) {
      var _underline3 = document.querySelector('#section4 .underline');

      _underline3.classList.add('extended');
    }
  }
}); // Parallax

var scene = document.getElementById('scene');
var iParallax = new parallax_js__WEBPACK_IMPORTED_MODULE_2___default.a(scene, {
  scalarX: 5,
  scalarY: 5
});
...
__webpack_require__(/*! D:\dev\wamp\www\ed64\resources\scripts\app.js */"./resources/scripts/app.js");
module.exports = __webpack_require__(/*! D:\dev\wamp\www\ed64\resources\styles\app.scss */"./resources/styles/app.scss");
